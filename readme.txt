...
Contributors: Nando Pappalardo
Tags: Featured Post with Thumbnail, Featured Post, Post, highlighting best articles,
...
1. This screen shot description corresponds 01-add-post-featured-post.(png|jpg|jpeg|gif).
2. This screen shot description corresponds 03-admin-widget-featured-post.(png|jpg|jpeg|gif).
3. This screen shot description corresponds 04-widget-featured-post-in-action.(png|jpg|jpeg|gif).


1. Add featured post.
2. Add featured post (small image).
3. Admin widget Featured Post.
4. Widget Featured Posts in action.
